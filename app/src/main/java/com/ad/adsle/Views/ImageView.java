...
//
//import com.ad.adsle.Util.GifViewUtils;
...
// * apply tints to an image} and handle {@link #setScaleType(android.widget.ImageView.ScaleType) image scaling}.
// *
// * <p>
...
//        postInit(GifViewUtils.initImageView(android.widget.ImageView, attrs, defStyleAttr, 0));
//    }
//
//    private void postInit(GifViewUtils.InitResult result) {
//        mFreezesAnimation = result.mFreezesAnimation;
//        if (result.mSourceResId > 0) {
//            setImageResource(result.mSourceResId);
//        }
//        if (result.mBackgroundResId > 0) {
//            setBackgroundResource(result.mBackgroundResId);
//        }
//    }
//
//    /**
